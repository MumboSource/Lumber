    ...
    {#each exeList as exe}
        <div class="flex py-3 px-5 h-24 w-full gap-5 items-center" style="border-bottom: 2px solid #E1E1E1;">
            ...
            <div class="grow overflow-hidden">
                <div class="font-normal text-2xl text-ellipsis overflow-hidden text-nowrap">{exe[0]}</div>
                <div class="font-normal text-base text-[#00000080] text-ellipsis overflow-hidden text-nowrap">Signed by {exe[1]} Inc.</div>
            </div>
